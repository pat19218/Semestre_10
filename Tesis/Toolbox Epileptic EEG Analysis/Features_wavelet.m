function [M_features,ritmo,coeff,tag] = Featureswavelet(eeg,muestras,c,waveletFunction,banda,op)
...
%La función utiliza 6niveles de descomposición para una Fs de 256Hz
