...
%  Algoritmo Basic Sequential Algorithmic Scheme (BSAS), usando como medida
%  de disimilitud d_ps_min: distancia entre punto y cluster es el mínimo de las
%  distancias (euclidianas) entre el punto y todos los puntos del cluster.
...
function [E,R] = BSAS_dpsmin(X, umbral, q)
N = size(X,1);
