...
class Registro(Frame):
    ...
    def create_wietgs(self):
        ...
        Label(self.frame2, text = 'INCIDENCIA', fg='white',bg ='navy', font=('Rockwell',13,'bold')).grid(column=0,row=4, pady=15)
        Label(self.frame2, text = 'DESCRIPCION',fg='white', bg ='navy', font=('Rockwell',13,'bold')).grid(column=0,row=5, pady=15)
